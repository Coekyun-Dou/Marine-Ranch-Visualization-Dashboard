...
COLORS = [
    ...
    (128, 128, 0), (0, 128, 0)]
LABELS = ['fish']
default_img_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'testdata', 'CS_videoplayback014.png')
img_src = cv2.imread(default_img_path) # 指向OpenCv对象
if img_src is None:
    img_src = np.zeros((720, 1280, 3), np.uint8)
tclose=False
truning=False
tsleep=False
